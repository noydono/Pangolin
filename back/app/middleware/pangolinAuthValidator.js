...
module.exports = (req,res,next) => {
    ...
    function pseudoValidator(username){
      ...
      if(!username){
        errors.push({ username: "Le pseudo et requis" });
        hasErrors = true;
      }else if (patternPseudo.test(username) === false) {
        errors.push({ username: "Pseudo non valide" });
        hasErrors = true;
      }
    };
    function emailValidator(email){
      ...
      if(!email){
        errors.push({ email: "L'email et requis" });
        hasErrors = true;
    ...
    function passwordValidator(password){
      ...
      if( !password){
        errors.push({ password: "Le password et requis" });
        hasErrors = true;
      }else if (
        patternPassword.test(password) === false
      ) {
        errors.push({ password: "Password non valide" });
        hasErrors = true;
      }
    };
    function ageValidator(age){
      ...
      if(!age){
        errors.push({ age: "L'age et requis" });
        hasErrors = true;
    ...
    function raceValidator(race){
      ...
      if(!race){
        errors.push({ race: "L'espèce et requis" });
        hasErrors = true;
      }
    ...
    function foodValidator(food){
      ...
      if(!food){
        errors.push({ food: "La nourriture et requis" });
        hasErrors = true;
    ...
    function familleValidator(famille){
      ...
      if(!famille){
        errors.push({ famille: "La famille et requis" });
        hasErrors = true;
